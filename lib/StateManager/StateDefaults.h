...
// #define DEFAULT_EDMX_PROTOCOL eDmxProtocol::ART_NET

#define DEFAULT_EDMX_MULTICAST false
...
#define DEFAULT_EDMX_UDP_ENABLED true
#define DEFAULT_EDMX_UDP_PORT 4510
