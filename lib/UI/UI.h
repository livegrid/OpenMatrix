...
class UI {
    public:
        ...
        typedef std::function<void(eDmxProtocol protocol, eDmxMode mode, bool multicast, uint16_t start_universe, uint16_t start_address, uint16_t timeout, bool udp_enabled, uint16_t udp_port)> onDmxSettingsCallback;
